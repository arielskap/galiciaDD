...
const Cobrar = () => {
  const { alt, img, imgDesktop, noSeguros } = json;
  ...
  return (
    <main className='cobrar animated fadeIn lg:relative'>
      <div className={`relative lg:h-64 lg:bg-no-repeat lg:bg-cover ${!imgDesktop && 'lg:bg-fixed'}`} style={{ backgroundImage: `url(${imgDesktop || img})`, }}>
        <img className='object-cover object-top w-full h-48 lg:hidden' src={img} alt={alt} />
        <div className='bottom-1 bg-red-transparent-soft w-7/12 h-5 absolute' />
      </div>
 ...
 <div className='my-4'>
        <div>
          <h1 className='mx-4 montserrat-b lg:text-2xl'>
            ...
            {' '}
            <span className='text-right w-full block lg:inline'>{titulo2}</span>
          </h1>
        ...
        <div className='mx-4'>
          <div>
            <p className='text-gray montserrat-l text-sm text-center'>
              {texto}
            </p>
          ...
          <div className='text-center'>
            <p className='text-gray mb-2 montserrat-l text-sm'>También pueden optar por ingresar a nuestra&nbsp;web</p>
            <a className='text-lg montserrat-b' href='https://www.galiciaseguros.com.ar'>www.galiciaseguros.com.ar</a>
            <p className='text-gray mt-2 montserrat-l text-sm'>
              en la sección
              {' '}
