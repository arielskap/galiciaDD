...
class HomeParent extends React.Component {
  ...
  render() {
    return (
      <div className='swiper-container swiper-container-h swiper-container-home overflow-y-hidden'>
        <div className='swiper-wrapper'>
          <div className='swiper-home swiper-slide' data-hash='Home'>
            <Home />
          </div>
          <div className='swiper-slide swiper-pagination-hidden' data-hash='Menu' />
        </div>
      </div>
    );
  }
