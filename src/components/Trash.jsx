...
¿Qué hacer
            ...
            <p className='text-sm pr-16 pb-2 text-gray'>Comunicate al Centro de Atención al Cliente dentro de las 72 horas de ocurrido el siniestro, llamando al 0800 555 9998 de lunes a viernes de 8 a 20hs</p>
          </div>
        </div>
